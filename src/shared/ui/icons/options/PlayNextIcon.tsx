...
export function PlayNextIcon({ className = '' }: Props) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none">
      ...
      <path d="M9.37988 12.0001V10.6101C9.37988 8.89008 10.5999 8.18007 12.0899 9.04007L13.2899 9.73007L14.4899 10.4201C15.9799 11.2801 15.9799 12.6901 14.4899 13.5501L13.2899 14.2401L12.0899 14.9301C10.5999 15.7901 9.37988 15.0901 9.37988 13.3601V12.0001Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      ...
      <path d="M20.4897 18.98H17.5098" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M19 17.52V20.51" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
}